public final class Rasterizer extends Rasterizer2D {
	...
	public static void method368(StreamLoader streamLoader)
	{
		...
		for(int j = 0; j < textureAmount; j++)
			try
			{
				...
				aBackgroundArray1474s[j].setTransparency(255, 0, 255);
				anInt1473++;
			}
			catch(Exception _ex) { }
		...
		if (background.anInt1452 == 64) {
			for (int j1 = 0; j1 < 128; j1++) {
				for (int j2 = 0; j2 < 128; j2++)
					texels[0][j2 + (j1 << 7)] = texturePalette[background.palettePixels[(j2 >> 1) + ((j1 >> 1) << 6)]];

			}

		} else {
			for (int k1 = 0; k1 < 16384; k1++)
				texels[0][k1] = texturePalette[background.palettePixels[k1]];
	...
	public static void drawTexturedTriangle(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18) {
		int[] texturePixels = getTexturePixels(var18)[mipMapLevel];
		int var21;
	...
	public static int textureAmount = 98;
