...
//			BufferedImage image = ImageIO.read(new URL("http://www.Valius.com/Media/icon.png"));
...
//				trayIcon.displayMessage(ClientConstants.CLIENT_NAME, "Valius client has been started!", MessageType.INFO);
//			}
//		}
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (cmd != null) {
			...
			if (cmd.equalsIgnoreCase("Forums")) {
				Client.instance.launchURL("www.Valius.org/community/");
			} else if (cmd.equalsIgnoreCase("Vote")) {
				Client.instance.launchURL("www.Valius.org/vote/");
			} else if (cmd.equalsIgnoreCase("Store")) {
				Client.instance.launchURL("www.Valius.org/store/");
			} else if (cmd.equalsIgnoreCase("Highscores")) {
				Client.instance.launchURL("www.Valius.org/hiscores/");
			} else if (cmd.equalsIgnoreCase("Guides")) {
				Client.instance.launchURL("http://valius.org/community/index.php?/forum/13-guides/");
			}
		}
	}
}