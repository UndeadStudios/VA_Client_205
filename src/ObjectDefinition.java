public final class ObjectDefinition {
	...
	//	if (i == 25016) {
			//class46.anIntArray773[0] = 25016; // Model ID 1077 = Null/invisible 
		//	class46.aBoolean767 = false; // Clipped | False = Walk through | True = Can't walk through
		//	}
		...
		case 29171:
			class46.name = "Mounted Fire Max Cape";
			class46.actions = new String[5];
			class46.actions[0] = "Take";
		...
		case 29172:
			class46.name = "Mounted Saradomin Max Cape";
			class46.actions = new String[5];
			class46.actions[0] = "Take";
			class46.actions[1] = null;
			break;
		case 29173:
			class46.name = "Mounted Zamorak Max Cape";
			class46.actions = new String[5];
			class46.actions[0] = "Take";
			class46.actions[1] = null;
			break;
		case 27282:
			class46.name = "Event Chest";
			break;
		case 29174:
			class46.name = "Mounted Guthix Max Cape";
			class46.actions = new String[5];
			class46.actions[0] = "Take";
			class46.actions[1] = null;
			break;
		case 29175:
			class46.name = "Mounted Ava's Max Cape";
			class46.actions = new String[5];
			class46.actions[0] = "Take";
			class46.actions[1] = null;
			break;
		...
		case 10060:
		case 10061:
			class46.name = "Grand exchange booth";
			class46.actions = new String[5];
		...
		case 27886:
			class46.name = "Gem rock";
			class46.actions = new String[5];
			class46.actions[0] = "Mine";
			class46.actions[1] = "Prospect";
			break;
...
//			System.out.println(Arrays.toString(childrenIDs));
	...
	public Model method581(int j, int k, int l) {
		...
		model_3.light(85 + aByte737, 768 + aByte742 * 25, -50, -10, -50,
				 !aBoolean769);
		if (supportItems == 1)
